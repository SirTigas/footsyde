...
<div class="container-fluid" style="margin:30px 0px 0px 0px">
    ...
    @else
        <form action="{{ route('admin.update') }}" method="POST">
            <div class="col d-flex justify-content-center" style="margin: 0px 0px 10px 0px">
                <button type="submit" class="btn btn-success" style="margin: 0px 0px 0px 0px"><i class="bi bi-floppy-fill"></i> <b>SALVAR ALTERAÇÕES</b></button>
            </div>
                                        ...
                                        <div class="d-flex justify-content-between align-items-center mt-2"> 
                                            <div class="d-flex justify-content-end">
                                                ...
                                                <form action="{{ route('admin.destroy') }}" method="POST">
                                                    ...
                                                    <button type="submit" class="btn btn-danger" style="margin:0px 0px 0px 10px"><i class="bi bi-trash-fill"></i> <b>REMOVER PRODUTO</b></button>
                                                </form>                                                                
                                            </div>                              
                                        </div>
                                    </div>
