                                    ...
                                    <div>
                                        ...
                                        <div class="row mt-4">
                                            <div class="col">
                                                ...
                                                <p class="card-text">Gênero: <b>{{ $od->product->category->name }}</b></p>
                                                <p class="card-text">Data do pedido: <b>{{ $od->created_at->format('d/m/Y') }}</b></p>
                                                <p class="card-text">Status: <b>{{ strtoupper($od->status) }}</b></p>
                                                <p class="card-text">Método de pagamento: <b>{{ $od->payment_method === 'credit' ? 'Crédito' : 'Pix' }}</b></p>
                                                <p class="card-text">Tamanho: <b>{{ $od->size->size }}</b></p>
                                                <p class="card-text">Preço unitário: <b>R$ {{ number_format($od->pc_price, 2, ',', '.') }}</b></p>
                                                <p class="card-text">Quantidade: <b>{{ $od->quantity }}</b></p>
                                                <p class="card-text">Total do pedido: <b>R$ {{ number_format($od->total_price, 2, ',', '.') }}</b></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
